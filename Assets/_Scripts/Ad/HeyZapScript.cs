...
public class HeyZapScript : MonoBehaviour {
    ...
    static public HeyZapScript Instance { get { return _instance; } }
    static public HeyZapScript _instance;
	...
	void Update () {
        ...
        HZIncentivizedAd.AdDisplayListener listenerRewardedAd = delegate (string adState, string adTag) {
        ...
        HZIncentivizedAd.SetDisplayListener(listenerRewardedAd);
